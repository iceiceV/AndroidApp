...
public class BleService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.ice.android.icedevice.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.ice.android.icedevice.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.ice.android.icedevice.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.ice.android.icedevice.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.ice.android.icedevice.EXTRA_DATA";

    public final static String MLDP_PRIVATE_SERVICE = "00035b03-58e6-07dd-021a-08123a000300";
    public final static String MLDP_CONTROL_PRIVATE_CHAR = "00035b03-58e6-07dd-021a-08123a0003ff";
    public final static String MLDP_DATA_PRIVATE_CHAR = "00035b03-58e6-07dd-021a-08123a000301";
    public final static String CHARACTERISTIC_CLIENT_CONFIG = "00002902-0000-1000-8000-00805f9b34fb";
    public final static UUID mServUUID = UUID.fromString(MLDP_PRIVATE_SERVICE);
    public final static UUID UUID_MLDP_DATA_PRIVATE_CHARACTERISTIC =
            UUID.fromString(MLDP_DATA_PRIVATE_CHAR);
    public final static UUID UUID_CHARACTERISTIC_CLIENT_CONFIG = UUID.fromString(CHARACTERISTIC_CLIENT_CONFIG);
    public final static ParcelUuid PARCEL_UUID_BLE_SERVICE =
            ParcelUuid.fromString(MLDP_PRIVATE_SERVICE);
    ...
    private void broadcastUpdate(final String action,
        ...
        // This is special handling for the RN4020, code copied from
        // Microchip PICtail RN4020die2 example
    ...
    // ----------------------------------------------------------------------------------------------------------------
    // Code copied from Microchip PICtail RN4020die2 example
    // Write to a given characteristic. The completion of the write is reported asynchronously
    // through the BluetoothGattCallback onCharacteristicWrire callback method.
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        if ((test & BluetoothGattCharacteristic.PROPERTY_WRITE) == 0 &&
                (test & BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE) == 0) { //Check that the property is writable
            return;
        }
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        BluetoothGattDescriptor descriptor =
                characteristic.getDescriptor(UUID_CHARACTERISTIC_CLIENT_CONFIG);
        Log.i(TAG, "The descriptor: " + descriptor);
...
//        if (UUID_MLDP_DATA_PRIVATE_CHARACTERISTIC.equals(characteristic.getUuid())) {
        BluetoothGattDescriptor descriptor =
                characteristic.getDescriptor(UUID_CHARACTERISTIC_CLIENT_CONFIG); //Get the descripter that enables indication on the server
